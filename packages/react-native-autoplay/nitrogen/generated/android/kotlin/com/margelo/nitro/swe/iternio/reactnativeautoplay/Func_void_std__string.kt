...
/**
 * Represents the JavaScript callback `(templateId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(templateId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(templateId: String): Unit
    = invoke_cxx(templateId)

  @FastNative
  private external fun invoke_cxx(templateId: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(templateId: String): Unit {
    return this.function(templateId)
  }
}
